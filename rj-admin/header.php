      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="#" onclick="show()">Export profiles in excel sheet</a><span><hr /></span></li>
...
<script>
	function show(){
		$('#output').html("<img src='http://synthesis.ac.in/synthesis_result/rj-admin/include/images/loading.gif' height='200' width='200'>");
		$.ajax({
			url:"module/profile/create_profile_excel.php",
			success:function(e){
				$('#output').html(e);
			}
		});
