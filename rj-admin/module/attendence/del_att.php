<?php
  if(isset($_GET['dyear'])){
    $id=$_GET['dyear'];
    $table=$_GET['table'];
    mysqli_query($con,"delete from $table where year=$id");
  }
 ?>
...
<script type="text/javascript">
  function search() {
    ...
    //alert(month);
      $.ajax({
          url:"module/attendence/del_show_att.php",
...
<script type="text/javascript">
  function del(year) {
    month=$('#month').val();
    location.href="index.php?mod=attendence&do=del_att&dyear="+year+"&table="+month;
  }
</script>
