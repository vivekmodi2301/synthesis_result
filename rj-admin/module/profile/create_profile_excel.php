...
"<b>Remark</b>"
	...
	//echo "select  `m_name`, class.name as class, batch.name as batch, `email`, `f_mobile`, `m_mobile`, `s_mobile`, `gender`, `cat`, `dob`, `ll_no`, `adrs`, `state`, `district`, `pin`, `propic`, `10th_roll`, `10th_%`, `10th_school_name`, `10th_board`, `12th_roll`, `12th_%`, `12th_school_name`, `12th_board`, `aipmt_roll`, `aiims_roll`, `aipvt_roll`, `iit_roll`, `remark`, `fee_disc`, `doa`,`roll`, `s_name`, `f_name`,student_biodata.id from student_biodata join class on class=class.id join batch on batch=batch.id";exit;
//print_r($data);
	$i=1;
