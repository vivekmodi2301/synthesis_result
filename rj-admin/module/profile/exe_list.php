<?php
  if (isset($_GET['did'])) {
    $file=fetchOne("select filename from profileexcel where id=$_GET[did]");
    delete('profileexcel',$_GET['did']);
    if (file_exists("profile_exe/".$file['filename'])) {
      unlink("profile_exe/".$file['filename']);
    }
  }
 ?>
<div class="col-lg-12 table-resposive" style=" font-family:'Century Gothic';">
   <table class="table table-bordered table-hover" style="margin:0" id="spr_table">
            <tr class="active1 table_style" style="font-weight:600;">
              ...
              <?php
              $sno=1;
                $att_detail=fetchAll("select id,filename,datee from profileexcel order by id desc");
              ...
              <tr>
                ...
                <td>
                  <a href="profile_exe/<?php echo $att_detail['filename'];?>">Download</a> |
...
<script type="text/javascript">
  function del(id) {
    if (confirm("Do you want to delete")) {
      location.href="index.php?mod=profile&do=exe_list&did="+id;
    }
  }
</script>
